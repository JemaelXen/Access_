...
>(({ className, ...props }, ref) => {
  // Ensure we're not passing null or undefined values to the component
  const safeProps = { ...props }

  // Handle any potentially problematic props
  if (safeProps.value === null || safeProps.value === undefined) {
